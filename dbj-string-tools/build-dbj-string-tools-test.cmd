...
@clang-cl %sourcebasename%.c /I "D:\machine_wide" /GR- /MTd /D_DEBUG /D_CRT_SECURE_NO_WARNINGS /D_HAS_EXCEPTIONS=0 /nologo /Zi /W3 /Fo%build%\ /Fe%build%\%sourcebasename%.exe 
