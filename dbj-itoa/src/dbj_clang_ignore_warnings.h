...
Micro managing the dreaded warning 4996, is recommended. But how?

why not trying the MSVC warning(supress: XXXX) pragma?
but it has to be on a line immediately before the line you want to silence the cl.exe about

using this macro you do not have to put it on separate previous line
and indeed sometimes one must use it. Example
...
#else
// Just CL has warning suppress, use DBJ_DISABLE_4996 instead, once per file
#define SUPR4996
#endif